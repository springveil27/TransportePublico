...
async function loadRoutes() {
    try {
        ...
        loadRoutesForSelect(); // Cargar opciones para selects
    } catch (error) {
...
async function loadStops() {
    try {
        ...
        // Asegurarnos de que tenemos las rutas cargadas
        ...
        for (const route of currentRoutes) {
            try {
                ...
                // Continuar con las otras rutas si una falla
            }
        }
        
        currentStops = allStops;
        displayStops(currentStops);
        await loadRoutesForSelect(); // Cargar opciones para el formulario
    } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Manejo del formulario de paradas
...
function formatTime(timeString) {
  ...
  // si es un timespan lo convertimos a formato string HH:MM
...
function formatTimeForInput(timeString) {
    // Convertir TimeSpan a formato de input time (HH:MM)
